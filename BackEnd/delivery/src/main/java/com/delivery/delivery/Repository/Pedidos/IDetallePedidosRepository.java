...
//METODO ABSTRACTO PARA FILTRAR LOS IDPLATOS CORRESPONDIENTES AL IDPEDIDO DEL PARAMETRO
    @Query(value = "SELECT id_plato FROM detalle_pedidos WHERE id_pedido = :idPedido", nativeQuery = true)
    List<Long> findIdPlatosXIdPedido(@Param("idPedido") Long idPedido);
